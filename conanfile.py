...
class chromium_tcmalloc_conan_project(conan_build_helper.CMakePackage):
    name = "chromium_tcmalloc"
    ...
    description = "modified `tcmalloc` library from chromium"
    topics = ('c++')
    ...
    def package_info(self):
        #self.cpp_info.libs = ["chromium_tcmalloc"]
